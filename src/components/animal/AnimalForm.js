...
export const AnimalForm = () => {
    // State will contain both animal data as well as isLoading flag.
    ...
    const handleControlledInputChange = (event) => {
       /* When changing a state object or array,
        ...
        let selectdVal = event.target.value
        // forms always provide values as strings. But we want to save the ids as numbers.
        if(event.target.id.includes("Id")) {
            selectdVal = parseInt(selectdVal)
        }
        /* Animal is an object with properties.
		Set the property to the new value
		using object bracket notation. */
        newAnimal[event.target.id] = selectdVal
        // update State
        setAnimal(newAnimal)
    }
...
//The bracket notation is there to dynamically access a key on the object. 
//In this case, it’s used to access either the customerId or locationId on the newAnimal object… 
//and then set it to the value of the selected option from the corresponding select menu